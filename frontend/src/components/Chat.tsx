...
import type { AgentEvent, AgentStage, ChatMessage, PlanStep } from '../types'
...
export default function Chat({ messages, plan, events, loading, error, stage, connected, runId, onSend }: { messages: ChatMessage[]; plan: PlanStep[]; events: AgentEvent[]; loading: boolean; error?: string; stage: AgentStage; connected: boolean; runId?: string; onSend: (message: string) => void }) {
